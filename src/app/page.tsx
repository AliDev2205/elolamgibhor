    ...
    <>
      ...
      <section className="relative w-full min-h-screen flex items-stretch pt-[72px]">
        <div className="flex flex-col lg:flex-row w-full">
          ...
          {/* Left content */}
          <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-12 lg:px-20 xl:px-24 py-16 lg:py-0 bg-white">
...
{/* ═══════════════════════════════════════════════════
    2. PROBLÈMES CLIENTS
═══════════════════════════════════════════════════ */}
<section style={{ backgroundColor: "#4A4540" }} className="w-full py-24 md:py-32">
...
<section style={{ backgroundColor: "#0A0A0A", padding: "72px 0" }} className="w-full">
  <div className="w-full px-6 sm:px-8 lg:px-12 xl:px-14" style={{ maxWidth: "1100px", marginLeft: "auto", marginRight: "auto" }}>
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
      ...
      {/* ═══════════════════════════════════════════════════
    7. PROCESSUS — Timeline verticale
═══════════════════════════════════════════════════ */}
<section style={{ backgroundColor: "#C8D0E0", padding: "80px 0 100px" }} className="w-full">
  <div className="w-full px-6 sm:px-8 lg:px-12 xl:px-14" style={{ maxWidth: "1100px", marginLeft: "auto", marginRight: "auto" }}>
    ...
    {/* Timeline — même disposition desktop/mobile */}
      ...
      {[
        {
          ...
          side: "right", // contenu à droite de la ligne
        },
        {
          num: "02",
        ...
        <AnimatedSection key={idx} animation="fadeInUp" delay={idx * 0.1}>
          <div className="relative grid grid-cols-2 gap-0 mb-16 sm:mb-[100px]">
            ...
            {step.side === "right" ? (
              <>
                ...
                <div className="pl-3 sm:pl-6 lg:pl-14">
                  {/* Numéro */}
                  <p style={{
                    fontFamily: "Georgia, 'Times New Roman', serif",
              ...
              <>
                ...
                <div className="pr-3 sm:pr-6 lg:pr-14 text-right">
                  <p style={{
                    fontFamily: "Georgia, 'Times New Roman', serif",
                    fontSize: "clamp(1.8rem, 4vw, 3.5rem)",
                    fontWeight: "900",
...
<section style={{ backgroundColor: "#0A0A0A", padding: "80px 0" }} className="w-full">
  <div className="w-full px-6 sm:px-8 lg:px-12 xl:px-14" style={{ maxWidth: "1100px", marginLeft: "auto", marginRight: "auto" }}>
    ...
    9. FAQ
═══════════════════════════════════════════════════ */}
<section style={{ backgroundColor: "#C8D0E0", padding: "80px 0" }} className="w-full">
  <div className="w-full px-6 sm:px-8 lg:px-12 xl:px-14" style={{ maxWidth: "1100px", marginLeft: "auto", marginRight: "auto" }}>
